    ...
    <div className="w-full px-4 md:py-2 py-2.5 flex justify-between items-center bg-teal-500 rounded-sm text-neutral-950 relative">
      ...
      >
        ...
        <div
          ...
          } absolute top-2/4 right-4 z-10 max-w-xs w-44 grid grid-flow-row auto-rows-[40px] p-1 shadow rounded-sm bg-teal-500 shadow-neutral-950 dark:shadow-neutral-50 `}
        >
          {/* Botones */}
          <button
